...
Internally, this macro uses a small interpreter that verifies and expands the
...
[`repetitive`]: https://docs.rs/repetitive/latest/repetitive/macro.repetitive.html
[`$for`]: https://docs.rs/repetitive/latest/repetitive/macro.repetitive.html#for
[`$if`]: https://docs.rs/repetitive/latest/repetitive/macro.repetitive.html#if
[`$let`]: https://docs.rs/repetitive/latest/repetitive/macro.repetitive.html#let
[macro documentation]: https://docs.rs/repetitive/latest/repetitive/macro.repetitive.html
